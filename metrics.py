...
def cal_bleu(path_refs, path_hyp):
	...
	process = subprocess.Popen(
			['perl', 'moses/multi-bleuN.pl'] + path_refs, 
...
def _write_xml(paths_in, path_out, role, n_line=None):
	...
	lines = [
		...
		'<!DOCTYPE mteval SYSTEM "xml generated using https://github.com/golsun/NLP-tools">',
		'<!-- generated by https://github.com/golsun/NLP-tools -->',
		'<!-- from: %s -->'%paths_in,
		'<!-- as inputs for https://raw.githubusercontent.com/moses-smt/mosesdecoder/master/scripts/generic/mteval-v14.pl -->',
		'<mteval>',
		]
