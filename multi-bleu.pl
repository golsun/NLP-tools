...
# https://github.com/moses-smt/mosesdecoder/blob/master/scripts/generic/multi-bleu.perl#L7

# perl multi-bleu.pl ref/test.tgt.160k < hu-512-ted-512/1m-beam10/decode.tgt.1st.160k
...
$bleu = $brevity_penalty * exp((my_log( $bleu[1] ) +
				...
				my_log( $bleu[3] ) +
				my_log( $bleu[4] ) ) / 4) ;
print "BLEU\tBLEU1\tBLEU2\tBLEU3\tBLEU4\tBP\tratio\thyp_len\tref_len\n";
